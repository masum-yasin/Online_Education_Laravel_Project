        ...
        <div class="row">
            <div class="col-lg-8 course_details_left">
                <div class="main_image">
                    <img class="img-fluid" src="{{asset('uploads/'.$courses->image)}}" alt="">
                </div>
                <div class="content_wrapper">
                    <h4 class="title_top">Course Objectives</h4>
                    <div class="content">
                       {{$courses->description}}
                    </div>
                    ...
                    <div class="comments-area mb-30">
                        <div class="comment-list">
                            <div class="single-comment single-reviews justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="frontend/assets/img/cource/cource_1.png" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list">
                            <div class="single-comment single-reviews justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="frontend/assets/img/cource/cource_2.png" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list">
                            <div class="single-comment single-reviews justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="frontend/assets/img/cource/cource_3.png" alt="">
                                    </div>
                                    <div class="desc">
